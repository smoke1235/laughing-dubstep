...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		closeText: 'Gereed', // Display text for close link
...
$.fn.position = function( options ) {
	...
	return this.each(function() {
		var elem = $( this ),
			...
			marginLeft = parseInt( $.curCSS( this, "marginLeft", true ) , 10) || 0,
			marginTop = parseInt( $.curCSS( this, "marginTop", true ) , 10) || 0,
			collisionWidth = elemWidth + marginLeft +
				( parseInt( $.curCSS( this, "marginRight", true ) , 10) || 0 ),
			collisionHeight = elemHeight + marginTop +
				( parseInt( $.curCSS( this, "marginBottom", true ) , 10) || 0 ),
